"""
Django settings for my_recipe_website project.
...
SECRET_KEY = 'django-insecure-@ru-)(71en*rks*d7kl%$6xg)-!f+vl#+z7uw-sh8zb2c$b^fi'
...
ROOT_URLCONF = 'my_recipe_website.urls'
...
WSGI_APPLICATION = 'my_recipe_website.wsgi.application'
